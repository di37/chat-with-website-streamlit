...
file_handler = RotatingFileHandler(log_filepath, maxBytes=max_log_size, backupCount=backup_count)
...
console_handler.setLevel(logging.INFO)  # Less verbose level for console, but will show warnings and errors
